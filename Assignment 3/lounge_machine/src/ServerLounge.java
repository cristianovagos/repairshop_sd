...
public class ServerLounge {
    ...
    public static void main(String[] args) {
        ...
        Lounge lounge = new Lounge(Constants.NUM_CUSTOMERS, Constants.NUM_REPLACEMENT_CARS, repositoryInterface);
        ...
        try {
            reg.bind(nameEntryObject, loungeInterface);
        } catch (RemoteException e) {
