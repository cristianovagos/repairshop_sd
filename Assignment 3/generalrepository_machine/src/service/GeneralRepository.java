...
public class GeneralRepository {
    ...
    /**
     * Número de clientes na fila da Recepção
    ...
    /**
     * Número de serviços pedidos pelo Gerente
     */
    private int requestedServices;

    /**
     * Número de peças em stock na Área de Reparação
     */
    ...
    /**
     * Indicação se o Gerente já foi alertado para a falta
     * de uma dada peça
     */
    private boolean[] partMissingAlert;

    /**
     * Número de peças vendidas pelo Fornecedor
     */
