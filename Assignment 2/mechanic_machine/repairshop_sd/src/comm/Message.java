...
public class Message implements Serializable {
    ...
    private boolean booleanParam2 = false;
    ...
    /**
     *  Instanciação de uma mensagem (forma 17):readThePaper respondse
     *
     *      @param type tipo da mensagem
    ...
    /**
     *  Instanciação de uma mensagem (forma 18):readThePaper respondse
     *
     *      @param type tipo da mensagem
