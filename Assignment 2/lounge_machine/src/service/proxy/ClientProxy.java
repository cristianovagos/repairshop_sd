...
/**
 *   Este tipo de dados define o thread agente prestador de serviço para o Lounge, uma das áreas partilhadas do
...
public class ClientProxy extends Thread implements IManagerAtt, ICustomerAtt, IMechanicAtt {
     ...
     *  @param loungeInterface interface ao Lounge
     */
    public ClientProxy (ServerCom sconi, LoungeInterface loungeInterface) {
        super ("LoungeProxy_" + getProxyId ());
        this.sconi = sconi;
    ...
    public void run() {
        ...
        try {
            outMessage = loungeInterface.processAndReply(inMessage);         // processá-lo
