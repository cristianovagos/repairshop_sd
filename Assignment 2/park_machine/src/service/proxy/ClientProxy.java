...
/**
 *   Este tipo de dados define o thread agente prestador de serviço para o Park, uma das áreas partilhadas do
...
public class ClientProxy extends Thread implements IManagerAtt, ICustomerAtt, IMechanicAtt {
     ...
     *  @param parkInterface interface ao Park
     */
    public ClientProxy (ServerCom sconi, ParkInterface parkInterface) {
        super ("ParkProxy_" + getProxyId ());
        this.sconi = sconi;
    ...
    public void run() {
        ...
        try {
            outMessage = parkInterface.processAndReply(inMessage);         // processá-lo
